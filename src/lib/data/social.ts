...
export const socialLinks: SocialLink[] = [
	...
	{
		title: 'Github',
		url: 'https://www.github.com/Metaphysics0',
		icon: 'fa-brands fa-github',
		target: '_blank'
	},
	{
		title: 'Instagram',
		url: 'https://www.instagram.com/mathrockryan',
		icon: 'fa-brands fa-instagram',
		target: '_blank'
	},
	{
		title: 'LinkedIn',
		url: 'https://www.linkedin.com/in/ryanroberts0',
		icon: 'fa-brands fa-linkedin',
		target: '_blank'
	},
	{
		title: 'Email',
		url: 'mailto:ryan@fullstackservices.io',
